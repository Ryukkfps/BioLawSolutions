        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive legal solutions for biotechnology, pharmaceutical, and life sciences companies. 
              Expert guidance from startup to market leadership.
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="py-20 px-8 bg-[#004d66] text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            ...
            your business navigate the complex world of biotechnology law.
          </p>
